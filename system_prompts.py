...
Never exceed 15 agents unless explicitly required by the user.
...
**IMPORTANT:**
- You must create **more than 2 but less than 16 agents** (i.e., 3 to 15 agents) to foster discussion and verification.
- Adjust the number of agents based on the complexity of the question, but stay within the 3-15 range.
